...
public class Principal {
	...
	public static void main(String[] args) {
		...
		while (escolha != -1){
			System.out.println("Digite a sua op��o: 1- cadastrar; 2-visualizar numeros; 3- visualizar �rg�os emissores de RGs");
			escolha = scan.nextInt();
			
			if (escolha == 1){
				System.out.println("Digite a sua op��o: 1- CPF; 2- RG");
				escolha=scan.nextInt();
				if (escolha == 1){
					...
					System.out.println("Digite o �rg�o emissor");
